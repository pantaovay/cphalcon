...
PHP_METHOD(Phalcon_Security_Random, bytes) {
	...
	if ((zephir_file_exists(&_3 TSRMLS_CC) == SUCCESS)) {
		...
		ZVAL_STRING(&_5$$7, "rb");
		ZEPHIR_CALL_FUNCTION(&handle, "fopen", NULL, 288, &_4$$7, &_5$$7);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Security_Random, number) {
	...
	ZEPHIR_INIT_VAR(&_6);
	ZVAL_STRING(&_6, "H*");
	ZEPHIR_CALL_FUNCTION(&_7, "pack", NULL, 423, &_6, &hex);
	zephir_check_call_status();
	zephir_concat_self(&bin, &_7 TSRMLS_CC);
	_8 = ZEPHIR_STRING_OFFSET(&bin, 0);
	ZVAL_LONG(&_4, _8);
	ZEPHIR_CALL_FUNCTION(&mask, "ord", &_9, 141, &_4);
	zephir_check_call_status();
	...
	do {
		...
		ZEPHIR_CALL_FUNCTION(&_17$$7, "ord", &_9, 141, &_16$$7);
		zephir_check_call_status();
		ZEPHIR_SINIT_NVAR(_18$$7);
		zephir_bitwise_and_function(&_18$$7, &_17$$7, &mask TSRMLS_CC);
		ZEPHIR_CALL_FUNCTION(&_17$$7, "chr", &_19, 139, &_18$$7);
		zephir_check_call_status();
		ZVAL_LONG(&_20$$7, 0);
		ZVAL_LONG(&_21$$7, 1);
		ZEPHIR_CALL_FUNCTION(&_22$$7, "substr_replace", &_23, 424, &rnd, &_17$$7, &_20$$7, &_21$$7);
		zephir_check_call_status();
		ZEPHIR_CPY_WRT(&rnd, &_22$$7);
	} while (ZEPHIR_LT(&bin, &rnd));
	ZEPHIR_INIT_NVAR(&_6);
	ZVAL_STRING(&_6, "H*");
	ZEPHIR_CALL_FUNCTION(&ret, "unpack", NULL, 420, &_6, &rnd);
	zephir_check_call_status();
	ZEPHIR_MAKE_REF(&ret);
	ZEPHIR_CALL_FUNCTION(&_24, "array_shift", NULL, 130, &ret);
	ZEPHIR_UNREF(&ret);
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_FUNCTION("hexdec", NULL, 425, &_24);
	zephir_check_call_status();
	RETURN_MM();
