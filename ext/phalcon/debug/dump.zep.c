...
PHP_METHOD(Phalcon_Debug_Dump, output) {
	...
	if (Z_TYPE_P(variable) == IS_ARRAY) {
		...
		zephir_is_iterable(variable, 0, "phalcon/debug/dump.zep", 156);
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(variable), _7$$4, _8$$4, _6$$4)
		{
			...
			ZVAL_LONG(&_9$$5, tab);
			ZEPHIR_CALL_FUNCTION(&_10$$5, "str_repeat", &_11, 140, &space, &_9$$5);
			zephir_check_call_status();
			...
			if (_18$$5) {
				...
				ZEPHIR_CALL_METHOD(&_19$$7, this_ptr, "output", &_22, 173, &value, &_20$$7, &_21$$7);
				zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_25$$4, "str_repeat", &_11, 140, &space, &_24$$4);
		zephir_check_call_status();
	...
	if (Z_TYPE_P(variable) == IS_OBJECT) {
		...
		ZEPHIR_CALL_FUNCTION(&_29$$8, "get_parent_class", &_30, 174, variable);
		zephir_check_call_status();
		if (zephir_is_true(&_29$$8)) {
			...
			ZEPHIR_CALL_FUNCTION(&_32$$9, "get_parent_class", &_30, 174, variable);
			zephir_check_call_status();
		...
		if (zephir_instance_of_ev(variable, phalcon_di_ce TSRMLS_CC)) {
			...
			ZEPHIR_CALL_FUNCTION(&_36$$10, "str_repeat", &_11, 140, &space, &_35$$10);
			zephir_check_call_status();
			...
			zephir_check_call_status();
			zephir_is_iterable(&_38$$11, 0, "phalcon/debug/dump.zep", 177);
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_38$$11), _40$$11, _41$$11, _39$$11)
			{
				...
				ZEPHIR_CALL_FUNCTION(&_43$$12, "str_repeat", &_11, 140, &space, &_42$$12);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_48$$12, this_ptr, "output", &_22, 173, &value, &_46$$12, &_42$$12);
				zephir_check_call_status();
			...
			do {
				...
				ZEPHIR_CALL_FUNCTION(&attr, "each", &_50, 175, variable);
				...
				ZVAL_LONG(&_52$$14, 0);
				ZEPHIR_CALL_FUNCTION(&_53$$14, "chr", &_54, 139, &_52$$14);
				zephir_check_call_status();
				...
				if (zephir_array_isset_long(&key, 1)) {
					...
					zephir_array_fetch_long(&_55$$17, &key, 1, PH_NOISY | PH_READONLY, "phalcon/debug/dump.zep", 200 TSRMLS_CC);
				...
				ZEPHIR_CALL_FUNCTION(&_56$$14, "str_repeat", &_11, 140, &space, &_52$$14);
				zephir_check_call_status();
				...
				ZEPHIR_MAKE_REF(&key);
				ZEPHIR_CALL_FUNCTION(&_58$$14, "end", &_59, 176, &key);
				ZEPHIR_UNREF(&key);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_61$$14, this_ptr, "output", &_22, 173, &value, &_51$$14, &_52$$14);
				zephir_check_call_status();
		...
		zephir_check_call_status();
		ZVAL_LONG(&_63$$8, tab);
		ZEPHIR_CALL_FUNCTION(&_64$$8, "str_repeat", &_11, 140, &space, &_63$$8);
		zephir_check_call_status();
		...
		if (zephir_fast_in_array(&_28$$8, &_63$$8 TSRMLS_CC)) {
			...
			ZEPHIR_CALL_FUNCTION(&_69$$19, "str_repeat", &_11, 140, &space, &_68$$19);
			zephir_check_call_status();
			ZEPHIR_INIT_VAR(&_70$$19);
			ZEPHIR_CONCAT_VS(&_70$$19, &_69$$19, "[already listed]\n");
			zephir_concat_self(&output, &_70$$19 TSRMLS_CC);
		} else {
			zephir_is_iterable(&attr, 0, "phalcon/debug/dump.zep", 226);
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&attr), _71$$20)
			{
				...
				if (ZEPHIR_IS_STRING(&value, "__construct")) {
					...
					ZEPHIR_CALL_FUNCTION(&_74$$22, "str_repeat", &_11, 140, &space, &_73$$22);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_FUNCTION(&_80$$23, "str_repeat", &_11, 140, &space, &_79$$23);
					zephir_check_call_status();
			...
			ZEPHIR_CALL_FUNCTION(&_86$$20, "str_repeat", &_11, 140, &space, &_85$$20);
			zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_89$$8, "str_repeat", &_11, 140, &space, &_88$$8);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_93, "is_float", NULL, 178, variable);
	zephir_check_call_status();
	...
	if (Z_TYPE_P(variable) == IS_STRING) {
		...
		ZEPHIR_CALL_FUNCTION(&_101$$27, "htmlentities", NULL, 159, variable, &_103$$27, &_102$$27);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_104$$27, "nl2br", NULL, 179, &_101$$27);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Debug_Dump, variables) {
	...
	zephir_check_call_status();
	zephir_is_iterable(&_0, 0, "phalcon/debug/dump.zep", 297);
