		...
		if (!(ZEPHIR_IS_EMPTY(&typeValues))) {
			if (Z_TYPE_P(&typeValues) == IS_ARRAY) {
				...
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&typeValues), _9$$37)
				{
					...
					ZVAL_STRING(&_10$$38, "\"");
					ZEPHIR_CALL_FUNCTION(&_11$$38, "addcslashes", &_12, 151, &value$$37, &_10$$38);
					zephir_check_call_status();
				...
				ZVAL_STRING(&_18$$39, "\"");
				ZEPHIR_CALL_FUNCTION(&_19$$39, "addcslashes", &_12, 151, &typeValues, &_18$$39);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect_Postgresql, createTable) {
	...
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&columns), _0)
	{
		...
		if (zephir_is_true(&_3$$7)) {
			...
			if (zephir_memnstr_str(&_4$$8, SL("BOOLEAN"), "phalcon/db/dialect/postgresql.zep", 382)) {
				...
				ZVAL_STRING(&_8$$11, "\"");
				ZEPHIR_CALL_FUNCTION(&_9$$11, "addcslashes", &_10, 151, &defaultValue, &_8$$11);
				zephir_check_call_status();
	...
	if (!(ZEPHIR_IS_EMPTY(&primaryColumns))) {
		ZEPHIR_CALL_METHOD(&_15$$14, this_ptr, "getcolumnlist", NULL, 54, &primaryColumns);
		zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&indexes, &definition, SL("indexes"), 0)) {
		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&indexes), _17$$15)
		{
			...
			if (ZEPHIR_IS_STRING(&indexName, "PRIMARY")) {
				...
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_18$$17, this_ptr, "getcolumnlist", NULL, 54, &_19$$17);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&indexSql);
				...
				if (!(ZEPHIR_IS_EMPTY(&indexType))) {
					...
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_20$$19, this_ptr, "getcolumnlist", NULL, 54, &_21$$19);
					zephir_check_call_status();
					ZEPHIR_INIT_NVAR(&indexSql);
					...
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_25$$20, this_ptr, "getcolumnlist", NULL, 54, &_26$$20);
					zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&references, &definition, SL("references"), 0)) {
		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&references), _28$$22)
		{
			...
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(&_30$$23, this_ptr, "getcolumnlist", NULL, 54, &_31$$23);
			zephir_check_call_status();
			...
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(&_34$$23, this_ptr, "getcolumnlist", NULL, 54, &_35$$23);
			zephir_check_call_status();
