...
PHP_METHOD(Phalcon_Validation_Validator_File, validate) {
	...
	zval field;
	zval *validation, validation_sub, *field_param = NULL, _SERVER, _POST, _FILES, value, message, label, replacePairs, types, byteUnits, unit, maxSize, matches, bytes, mime, tmp, width, height, minResolution, maxResolution, minWidth, maxWidth, minHeight, maxHeight, fieldTypes, code, _0, _3, _7, _10, _20, _22, _23, _36, _55, _64, _66, _1$$3, _2$$5, _11$$6, _14$$6, _16$$6, _12$$7, _13$$8, _24$$9, _27$$9, _28$$9, _25$$10, _26$$11, _31$$12, _34$$12, _35$$12, _32$$13, _33$$14, _37$$15, _39$$15, _40$$15, _41$$15, _42$$15, _43$$15, _45$$15, _46$$15, _47$$15, _48$$15, _49$$15, _38$$16, _50$$18, _53$$18, _54$$18, _51$$19, _52$$20, _56$$21, _57$$24, _58$$24, _59$$26, _62$$26, _63$$26, _60$$27, _61$$28, _67$$29, _68$$29, _69$$29, _78$$29, _70$$30, _71$$31, _73$$33, _76$$33, _77$$33, _74$$34, _75$$35, _79$$36, _80$$37, _82$$38, _85$$38, _86$$38, _83$$39, _84$$40;
	ZEPHIR_INIT_THIS();
	...
	if (_8) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_11$$6, "__construct", &_17, 450, &_14$$6, &field, &_16$$6, &code);
		zephir_check_call_status();
	...
	if (_21) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_24$$9, "__construct", &_17, 450, &_27$$9, &field, &_28$$9, &code);
		zephir_check_call_status();
	...
	if (_30) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_31$$12, "__construct", &_17, 450, &_34$$12, &field, &_35$$12, &code);
		zephir_check_call_status();
	...
	if (zephir_is_true(&_36)) {
		...
		ZEPHIR_CALL_FUNCTION(&_43$$15, "floatval", &_44, 312, &_42$$15);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_43$$15, "floatval", &_44, 312, &_48$$15);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_49$$15, "floatval", &_44, 312, &bytes);
		zephir_check_call_status();
		if (ZEPHIR_GT(&_43$$15, &_49$$15)) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_50$$18, "__construct", &_17, 450, &_53$$18, &field, &_54$$18, &code);
			zephir_check_call_status();
	...
	if (zephir_is_true(&_55)) {
		...
		if (!(zephir_fast_in_array(&mime, &types TSRMLS_CC))) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_59$$26, "__construct", &_17, 450, &_62$$26, &field, &_63$$26, &code);
			zephir_check_call_status();
	...
	if (_65) {
		...
		if (_72$$29) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_73$$33, "__construct", &_17, 450, &_76$$33, &field, &_77$$33, &code);
			zephir_check_call_status();
		...
		if (zephir_is_true(&_78$$29)) {
			...
			if (_81$$36) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_82$$38, "__construct", &_17, 450, &_85$$38, &field, &_86$$38, &code);
				zephir_check_call_status();
