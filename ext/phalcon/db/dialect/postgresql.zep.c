		...
		if (!(ZEPHIR_IS_EMPTY(&typeValues))) {
			if (Z_TYPE_P(&typeValues) == IS_ARRAY) {
				...
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&typeValues), _9$$37)
				{
					...
					ZVAL_STRING(&_10$$38, "\\'");
					ZEPHIR_CALL_FUNCTION(&_11$$38, "addcslashes", &_12, 149, &value$$37, &_10$$38);
					zephir_check_call_status();
				...
				ZVAL_STRING(&_18$$39, "\\'");
				ZEPHIR_CALL_FUNCTION(&_19$$39, "addcslashes", &_12, 149, &typeValues, &_18$$39);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect_Postgresql, createTable) {
	...
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval definition;
	zval *tableName_param = NULL, *schemaName_param = NULL, *definition_param = NULL, temporary, options, table, createLines, columns, column, indexes, index, reference, references, indexName, indexSql, indexSqlAfterCreate, sql, columnLine, indexType, referenceSql, onDelete, onUpdate, primaryColumns, columnDefinition, *_0, _34, _35, _38, _2$$7, _3$$7, _7$$7, _8$$7, _4$$8, _6$$8, _9$$11, _10$$12, _11$$12, *_12$$13, _13$$15, _14$$15, _15$$17, _16$$17, _17$$18, _18$$18, _19$$18, _20$$18, _21$$18, _22$$18, *_23$$20, _24$$21, _25$$21, _26$$21, _27$$21, _28$$21, _29$$21, _30$$21, _31$$21, _32$$22, _33$$23, _36$$24, _37$$24;
	zval tableName, schemaName;
	zval *this_ptr = getThis();
	...
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&columns), _0)
	{
		...
		if (zephir_is_true(&_8$$7)) {
			ZEPHIR_CALL_METHOD(&_9$$11, &column, "getname", NULL, 0);
			zephir_check_call_status();
			zephir_array_append(&primaryColumns, &_9$$11, PH_SEPARATE, "phalcon/db/dialect/postgresql.zep", 396);
		}
	...
	if (!(ZEPHIR_IS_EMPTY(&primaryColumns))) {
		ZEPHIR_CALL_METHOD(&_10$$12, this_ptr, "getcolumnlist", NULL, 50, &primaryColumns);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_11$$12);
		ZEPHIR_CONCAT_SVS(&_11$$12, "PRIMARY KEY (", &_10$$12, ")");
		zephir_array_append(&createLines, &_11$$12, PH_SEPARATE, "phalcon/db/dialect/postgresql.zep", 402);
	}
	...
	if (zephir_array_isset_string_fetch(&indexes, &definition, SL("indexes"), 0)) {
		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&indexes), _12$$13)
		{
			ZEPHIR_INIT_NVAR(&index);
			ZVAL_COPY(&index, _12$$13);
			...
			if (ZEPHIR_IS_STRING(&indexName, "PRIMARY")) {
				ZEPHIR_CALL_METHOD(&_14$$15, &index, "getcolumns", NULL, 0);
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_13$$15, this_ptr, "getcolumnlist", NULL, 50, &_14$$15);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&indexSql);
				ZEPHIR_CONCAT_SVS(&indexSql, "CONSTRAINT \"PRIMARY\" PRIMARY KEY (", &_13$$15, ")");
			} else {
				if (!(ZEPHIR_IS_EMPTY(&indexType))) {
					ZEPHIR_CALL_METHOD(&_16$$17, &index, "getcolumns", NULL, 0);
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_15$$17, this_ptr, "getcolumnlist", NULL, 50, &_16$$17);
					zephir_check_call_status();
					ZEPHIR_INIT_NVAR(&indexSql);
					ZEPHIR_CONCAT_SVSVSVS(&indexSql, "CONSTRAINT \"", &indexName, "\" ", &indexType, " (", &_15$$17, ")");
				} else {
					ZEPHIR_CALL_METHOD(&_17$$18, &index, "getname", NULL, 0);
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_18$$18, this_ptr, "preparetable", NULL, 0, &tableName, &schemaName);
					zephir_check_call_status();
					ZEPHIR_INIT_LNVAR(_19$$18);
					ZEPHIR_CONCAT_SVSV(&_19$$18, "CREATE INDEX \"", &_17$$18, "\" ON ", &_18$$18);
					zephir_concat_self(&indexSqlAfterCreate, &_19$$18 TSRMLS_CC);
					ZEPHIR_CALL_METHOD(&_21$$18, &index, "getcolumns", NULL, 0);
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_20$$18, this_ptr, "getcolumnlist", NULL, 50, &_21$$18);
					zephir_check_call_status();
					ZEPHIR_INIT_LNVAR(_22$$18);
					ZEPHIR_CONCAT_SVS(&_22$$18, " (", &_20$$18, ");");
					zephir_concat_self(&indexSqlAfterCreate, &_22$$18 TSRMLS_CC);
				}
			}
	...
	if (zephir_array_isset_string_fetch(&references, &definition, SL("references"), 0)) {
		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&references), _23$$20)
		{
			ZEPHIR_INIT_NVAR(&reference);
			ZVAL_COPY(&reference, _23$$20);
			ZEPHIR_CALL_METHOD(&_24$$21, &reference, "getname", NULL, 0);
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(&_26$$21, &reference, "getcolumns", NULL, 0);
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(&_25$$21, this_ptr, "getcolumnlist", NULL, 50, &_26$$21);
			zephir_check_call_status();
			ZEPHIR_INIT_NVAR(&referenceSql);
			ZEPHIR_CONCAT_SVSVS(&referenceSql, "CONSTRAINT \"", &_24$$21, "\" FOREIGN KEY (", &_25$$21, ") REFERENCES ");
			ZEPHIR_CALL_METHOD(&_28$$21, &reference, "getreferencedtable", NULL, 0);
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(&_27$$21, this_ptr, "preparetable", NULL, 0, &_28$$21, &schemaName);
			zephir_check_call_status();
			zephir_concat_self(&referenceSql, &_27$$21 TSRMLS_CC);
			ZEPHIR_CALL_METHOD(&_30$$21, &reference, "getreferencedcolumns", NULL, 0);
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(&_29$$21, this_ptr, "getcolumnlist", NULL, 50, &_30$$21);
			zephir_check_call_status();
			ZEPHIR_INIT_LNVAR(_31$$21);
			ZEPHIR_CONCAT_SVS(&_31$$21, " (", &_29$$21, ")");
			zephir_concat_self(&referenceSql, &_31$$21 TSRMLS_CC);
			ZEPHIR_CALL_METHOD(&onDelete, &reference, "getondelete", NULL, 0);
			zephir_check_call_status();
			if (!(ZEPHIR_IS_EMPTY(&onDelete))) {
				ZEPHIR_INIT_LNVAR(_32$$22);
				ZEPHIR_CONCAT_SV(&_32$$22, " ON DELETE ", &onDelete);
			...
			if (!(ZEPHIR_IS_EMPTY(&onUpdate))) {
				...
				ZEPHIR_CONCAT_SV(&_33$$23, " ON UPDATE ", &onUpdate);
	...
	if (zephir_array_isset_string(&definition, SL("options"))) {
		ZEPHIR_CALL_METHOD(&_36$$24, this_ptr, "_gettableoptions", NULL, 0, &definition);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_37$$24);
		ZEPHIR_CONCAT_SV(&_37$$24, " ", &_36$$24);
		zephir_concat_self(&sql, &_37$$24 TSRMLS_CC);
	}
	ZEPHIR_INIT_VAR(&_38);
...
PHP_METHOD(Phalcon_Db_Dialect_Postgresql, _castDefault) {
	...
	if (_5) {
		...
		ZVAL_STRING(&_7$$6, "\\'");
		ZEPHIR_CALL_FUNCTION(&_8$$6, "addcslashes", NULL, 149, &defaultValue, &_7$$6);
		zephir_check_call_status();
